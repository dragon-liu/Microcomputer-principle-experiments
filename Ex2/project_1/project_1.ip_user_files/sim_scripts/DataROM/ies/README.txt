...
#
# Generated by export_simulation on Fri Apr 05 08:29:35 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './DataROM.sh' script.

./DataROM.sh -reset_run
...
./DataROM.sh -noclean_files

For more information on the script, please type './DataROM.sh -help'.
