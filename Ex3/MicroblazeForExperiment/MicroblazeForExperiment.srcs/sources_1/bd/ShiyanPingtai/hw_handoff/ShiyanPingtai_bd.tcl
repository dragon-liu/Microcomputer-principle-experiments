...
################################################################
# This is a generated script based on design: ShiyanPingtai
#
...
# source ShiyanPingtai_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_IS_DUAL {1} \
   CONFIG.GPIO2_BOARD_INTERFACE {seven_seg_led_an} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports seven_seg_led_an] [get_bd_intf_pins axi_gpio_0/GPIO2]
